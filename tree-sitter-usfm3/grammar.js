module.exports = grammar({
  ...
  rules: {
    ...
    _bookHeader: $ => choice($.usfm, $.ide, $.hBlock, $.tocBlock, $.tocaBlock,
      $._comments, $.milestone, $._zNameSpace, $.esb, $.ref,
      ),
    ...
    _midIntroMarker: $ => choice($.imtBlock, $.isBlock, $.io, $.iot, $.ip, $.im,
      ...
      $.iqBlock, $.iex, $._comments, $.milestone, $._zNameSpace, $.esb),
    ...
    fr: $ => prec.right(0, seq("\\fr ", optional($.footnoteText), optional("\\fr*"))),
    fq: $ => prec.right(0, seq("\\fq ", optional($.footnoteText), optional("\\fq*"))),
    fqa: $ => prec.right(0, seq("\\fqa ", optional($.footnoteText), optional("\\fqa*"))),
    fk: $ => prec.right(0, seq("\\fk ", optional($.footnoteText), optional("\\fk*"))),
    fl: $ => prec.right(0, seq("\\fl ", optional($.footnoteText), optional("\\fl*"))),
    fw: $ => prec.right(0, seq("\\fw ", optional($.footnoteText), optional("\\fw*"))),
    fp: $ => prec.right(0, seq("\\fp ", optional($.footnoteText), optional("\\fp*"))),
    ft: $ => prec.right(0, seq("\\ft ", optional($.footnoteText), optional("\\ft*"))),
    fdc: $ => prec.right(0, seq("\\fdc ", optional($.footnoteText), optional("\\fdc*"))),
    fv: $ => seq("\\fv ", optional($.text), "\\fv*"),
    fm: $ => seq("\\fm ", optional($.footnoteText), "\\fm*"),
    ...
    xo: $ => prec.right(0,seq("\\xo ", optional($.crossrefText), optional("\\xo*"))),
    xk: $ => prec.right(0,seq("\\xk ", optional($.crossrefText), optional("\\xk*"))),
    xq: $ => prec.right(0,seq("\\xq ", optional($.crossrefText), optional("\\xq*"))),
    xt: $ => prec.right(0,seq("\\xt ", optional($.crossrefText),optional(choice($.defaultAttribute, $._attributesInCrossref)), 
      optional("\\xt*"))),
    xtNested: $ => prec.right(0, seq("\\+xt ", optional($.crossrefText),optional(choice($.defaultAttribute, $._attributesInCrossref)), 
      optional("\\+xt*"))),
    xt_standalone: $ => prec.right(0, seq("\\xt ", optional($.crossrefText),
      optional(choice($.defaultAttribute, $._attributesInCrossref)), 
      "\\xt*")),
    xta: $ => prec.right(0, seq("\\xta ", optional($.crossrefText), optional("\\xta*"))),
    xop: $ => prec.right(0, seq("\\xop ", optional($.crossrefText), optional("\\xop*"))),
    xot: $ => prec.right(0, seq("\\xot ", optional($.crossrefText), optional("\\xot*"))),
    xnt: $ => prec.right(0, seq("\\xnt ", optional($.crossrefText), optional("\\xnt*"))),
    xdc: $ => prec.right(0, seq("\\xdc ", optional($.crossrefText), optional("\\xdc*"))),
...
//      $.fig,
    ...
    zSpaceTagPara: $=> /\\customPara_z[\w\-]+/,
    zSpaceTagNote: $=> /\\customNote_z[\w\-]+/,
    zSpaceCloseNote: $=> /\\customNote_z[\w\d_-]+\*/,
