module.exports = grammar({
  ...
  rules: {
    ...
    xt: $ => seq("\\xt ", optional($.crossrefText),optional(choice($.defaultAttribute, $._attributesInCrossref)), 
      optional("\\xt*")),
    ...
    xt_standalone: $ => prec.right(0, seq("\\xt ", optional($.crossrefText),
      ...
      "\\xt*")),
    xta: $ => seq("\\xta ", optional($.crossrefText), optional("\\xta*")),
    xop: $ => seq("\\xop ", optional($.crossrefText), optional("\\xop*")),
    xot: $ => seq("\\xot ", optional($.crossrefText), optional("\\xot*")),
    xnt: $ => seq("\\xnt ", optional($.crossrefText), optional("\\xnt*")),
    xdc: $ => seq("\\xdc ", optional($.crossrefText), optional("\\xdc*")),
